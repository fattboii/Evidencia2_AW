<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('numero_pedido', $pedido->numero_pedido, ['class' => 'form-control' . ($errors->has('numero_pedido') ? ' is-invalid' : ''), 'placeholder' => 'Numero Pedido']) }}
            {!! $errors->first('numero_pedido', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
